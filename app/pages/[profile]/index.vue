...
<template>
  <UPage>
    <UPageBody>
      <div
        v-if="profile?.data"
        class="mt-24 rounded-lg border border-gray-200 bg-white p-8 shadow dark:border-gray-800 dark:bg-gray-900"
      >
        <div class="grid grid-cols-1 md:grid-cols-3">
          <div
            class="order-last mt-4 grid grid-cols-3 text-center md:order-first md:mt-0"
          >
            <div>
          ...
          <div class="mt-32 grid grid-cols-2 space-x-8 text-center lg:mt-0">
            <div>
              <p class="text-lg font-bold">
        ...
        <div class="mt-20 pb-4 text-center">
