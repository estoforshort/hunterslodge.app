...
CREATE TABLE `Profile` (
    ...
    `timeStreamed` INTEGER UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `PlatformsOnGames` (
    ...
    INDEX `PlatformsOnGames_platformId_idx`(`platformId`),
...
CREATE TABLE `Stack` (
    ...
    `profilesCount` SMALLINT UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `StackChange` (
    ...
    `rarityFrom` DECIMAL(7, 2) NOT NULL,
    `rarityTo` DECIMAL(7, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE `StackTrophyChange` (
    ...
    `rarityFrom` DECIMAL(7, 2) NOT NULL,
    `rarityTo` DECIMAL(7, 2) NOT NULL DEFAULT 1,
